...
public class IndexCreationEstimation {
	...
	public void createIndexToday(User user) throws ClassNotFoundException, SQLException, IOException, InterruptedException {
		...
		String inputDir = "/FinalProject/IndexCreationEstimation/input_" + user.getIdUser();
		String tfidfOutputDir = "/FinalProject/IndexCreationEstimation/output_" + user.getIdUser();
		String indexOutputDir = "/FinalProject/IndexCreationEstimation/outputindex_" + user.getIdUser();
		...
		this.hadoopManager.launchIndexCreationJob(tfidfOutputDir, indexOutputDir, "tmpdocument");
